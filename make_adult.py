...
# باقة شاملة ومباشرة وثابتة لجميع القنوات بدون الحاجة لاتصال خارجي يسبب فشل الـ Action
CHANNELS_DATA = [
    ...
    {"name": "Dusk TV", "url": "http://adulttv.host:8080/live/adult/adult/34.m3u8"}
]
...
def build_playlist():
    ...
    print("⚙️ جاري كتابة القنوات محلياً لضمان نجاح التحديث المباشر...")
    ...
    try:
        ...
        print(f"\n🚀 مريقل! تم توليد الملف بنجاح ويحتوي على {channels_count} قناة كاملة وثابتة.")
